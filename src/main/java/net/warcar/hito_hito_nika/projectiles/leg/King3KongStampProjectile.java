...
public class King3KongStampProjectile extends TrueGomuProjectile {
    ...
    public King3KongStampProjectile(Level world, LivingEntity player, Ability ability) {
        super(NikaProjectiles.GOMU_GOMU_NO_KING_3_KONG_STAMP.get(), player, ability, SourceElement.RUBBER, SourceHakiNature.HARDENING, SourceType.FIST, SourceType.PHYSICAL);
        this.setMaxLife(40);
        this.setPhysical();
        this.setDamage(100);
