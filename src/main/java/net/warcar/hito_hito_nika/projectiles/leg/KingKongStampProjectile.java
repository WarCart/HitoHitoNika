...
public class KingKongStampProjectile extends NuProjectileEntity {
    ...
    public KingKongStampProjectile(Level world, LivingEntity player, Ability ability) {
        super(NikaProjectiles.GOMU_GOMU_NO_KING_KONG_STAMP.get(), world, player, ability, SourceElement.RUBBER, SourceHakiNature.HARDENING, SourceType.FIST, SourceType.PHYSICAL);
        this.setMaxLife(25);
        this.setPhysical();
        this.setDamage(85);
