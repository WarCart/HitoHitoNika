...
public class RhinoSchneiderProjectile extends TrueGomuProjectile {
    ...
    public RhinoSchneiderProjectile(Level world, LivingEntity player, Ability ability) {
        super(NikaProjectiles.GOMU_GOMU_NO_RHINO_SCHNEIDER.get(), player, ability, SourceElement.RUBBER, SourceHakiNature.HARDENING, SourceType.FIST, SourceType.PHYSICAL);
        this.setDamage(40);
        this.setMaxLife(10);
        this.setSize(4.5f);
