...
public class StampProjectile extends TrueGomuProjectile {
    public StampProjectile(EntityType type, Level world) {
        super(type, world);
    }

    public StampProjectile(Level world, LivingEntity player, Ability ability) {
        super(NikaProjectiles.GOMU_GOMU_NO_STAMP.get(), player, ability, SourceElement.RUBBER, SourceHakiNature.HARDENING, SourceType.FIST, SourceType.PHYSICAL);
        this.setMaxLife(12);
        this.setDamage(8F);
        this.setSize(3.1f);
    }
