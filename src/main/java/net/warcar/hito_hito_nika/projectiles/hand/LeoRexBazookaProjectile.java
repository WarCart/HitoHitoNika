...
public class LeoRexBazookaProjectile extends TrueGomuProjectile {
    ...
    public LeoRexBazookaProjectile(Level world, LivingEntity player, Ability ability) {
        super(NikaProjectiles.GOMU_GOMU_NO_LEO_REX_BAZOOKA.get(), player, ability, SourceElement.RUBBER, SourceHakiNature.HARDENING, SourceType.FIST, SourceType.PHYSICAL);
        this.setDamage(120f);
        this.setMaxLife(10);
