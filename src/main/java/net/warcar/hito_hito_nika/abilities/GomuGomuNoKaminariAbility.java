...
public class GomuGomuNoKaminariAbility extends Ability {
    ...
    public static final AbilityCore<GomuGomuNoKaminariAbility> INSTANCE = (new AbilityCore.Builder<>("gomu_gomu_no_kaminari", "Gomu Gomu no Kaminari", AbilityCategory.DEVIL_FRUITS, GomuGomuNoKaminariAbility::new))
    ...
    public GomuGomuNoKaminariAbility(AbilityCore<GomuGomuNoKaminariAbility> core) {
        ...
        this.addCanUseCheck((e, a) -> AbilityUseConditions.requiresActiveAbility(e,a, TrueGearFifthAbility.INSTANCE));
