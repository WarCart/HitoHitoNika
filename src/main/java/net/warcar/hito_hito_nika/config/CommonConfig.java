...
public class CommonConfig {
    ...
    public CommonConfig(ForgeConfigSpec.Builder builder) {
        ...
        this.gatlingLength = builder.comment("Regulates length of gatling", "Old function: multiply(n(3), add(n(1), sqrt(divide(doriki(), multiply(n(100), dif())))))").define("Gatling length equation", "divide(n(10), dif())");
