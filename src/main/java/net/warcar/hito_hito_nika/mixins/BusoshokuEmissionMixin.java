...
public abstract class BusoshokuEmissionMixin extends ContinuousAbilityMixin implements IAbilityModeSwitcher {
	...
	protected void continueStop(PlayerEntity player, CallbackInfo info) {
		...
		this.disableModes(player, (BusoshokuHakiEmissionAbility) (Object) this);
	}
}
