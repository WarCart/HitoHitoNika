...
public class NPCGroups {
    public static final String STRAWHATS_NAME = getName("Strawhats");
    public static final UUID STRAWHATS_UUID = UUID.fromString("f7fea672-ca16-49b2-ae9a-eb6d8180faa8");
    public static final Crew STRAWHATS = new Crew(STRAWHATS_NAME, STRAWHATS_UUID, ModNPCGroups.CAPTAIN_MARKER, Instant.now().getEpochSecond());
