...
public class GearFourthTankmanModel<T extends LivingEntity> extends HumanoidMorphModel<T> {
	...
	public static final ResourceLocation OVERLAY = ResourceLocation.fromNamespaceAndPath(HitoHitoNoMiNikaMod.MOD_ID, "textures/models/g4_tankman_overlay.png");
	private boolean gomuAnimations = true;

	public GearFourthTankmanModel(ModelPart root) {
		super(root);
	}
